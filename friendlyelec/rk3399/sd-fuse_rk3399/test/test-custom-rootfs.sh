...
HTTP_SERVER=artifacts.cachengo.com
...
cd sd-fuse_rk3399
wget http://${HTTP_SERVER}/buildroot/RK3399/friendlycore-arm64-images.tgz
tar xzf friendlycore-arm64-images.tgz
wget http://${HTTP_SERVER}/buildroot/RK3399/emmc-flasher-images.tgz
tar xzf emmc-flasher-images.tgz
wget http://${HTTP_SERVER}/buildroot/RK3399/rootfs/rootfs-friendlycore-arm64.tgz
...
(cd friendlycore-arm64/rootfs/root/ && {
	wget http://${HTTP_SERVER}/buildroot/RK3399/friendlycore-arm64-images.tgz -O deleteme.tgz
});
